...
function ScoreDash() {
  ...
  const [time, setTime] = useState(new Date()import getUserLines from '../common/getUserLines')
  ...
  const handleCardPress = async (item) => {
    ...
    await AsyncStorage.setItem('userpage', item.user)
    ...
    <TouchableOpacity onPress={() => handleCardPress(item)} style={[styles.card]}>
      <View style={styles.cardContent}>
        <View style={styles.cardRow}>
          ...
          <Text style={styles.columnPlayer}>{item.user}</Text>
