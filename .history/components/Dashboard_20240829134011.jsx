    ...
    <TouchableOpacity onPress={() => handleCardPress(item)} style={[styles.card]}>
      <View style={styles.testCard}>
        <View style={styles.textLeft}>
          <Text style={styles.testRow}>{item.home_team}</Text>
          <Text style={styles.testRow}>{item.away_team}</Text>
  ...
  const testCard = () => {
    return (
      <View style={styles.card}>
        <View style={styles.textLeft}>
          <Text style={styles.row}>Row 1 Text</Text>
          <Text style={styles.row}>Row 2 Text</Text>
        </View>
        <View style={styles.textRight}>
          <Text style={styles.rightText}>Right Justified Text</Text>
        </View>
      </View>
    );
  };
...
const styles = StyleSheet.create({
  ...
  testCard: {
    width: width / 2,  // 1/8 of the screen width (adjust if needed)
  ...
  textRight: {
    ...
    alignItems: 'flex-end',
    justifyContent: 'center',
    height: 20, // Adjust height to match the text height
  },
  tesow: {
    marginBottom: 8,
  },
