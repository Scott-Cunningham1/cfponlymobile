    ...
    <View style={styles.userGamesCard}>
      ...
      <View style={styles.teamContainer}>
        <View style={styles.leftSection}>
          <Text style={styles.teamText}><Image style={styles.image} source={getImageSource(item.home_team)} />{item.home_points<Text style={styles.infoText}>{item.quarter || 'N/A'} | {item.time || 'N/A'} | {item.down || 'N/A'} | {item.possession || 'N/A'}</Text>}{item.home_points}</Text>
          <Text style={styles.teamText}><Image style={styles.image} source={getImageSource(item.away_team)} />{item.away_team}      {item.away_points}</Text>
