...
import { Linking, Image, View, Text, FlatList, StyleSheet, Dimensions, TouchableOpacity, Scro } from 'react-native';
  ...
  const navigation = useNavigation();
    ...
    const getInfo = useCallback( async () => {
      try {
        ...
        const userTeamsData = await getUserTeams(tokenData, 3);
        setUserTeams(userTeamsData);
        console.log("userTeams:", userTeams)
        console.log("week:", week)

        const userLinesData = await getUserLines(tokenData, 3, week);
