  ...
  const DataTitlesCard = () => (
    <View style={styles.dataTitlesCard}>
      <View style={styles.dataTitlesCardRow}>
        ...
        <Text style={styles.dataTitlesTextTeam}>Team</Text>
        <Text style={styles.dataTitlesTextTotal}>Wins</Text>
        <Text style={styles.dataTitlesmiddleCardextLosses}>Losses</Text>
      </View>
    </View>
  );
