    ...
    <TouchableOpacity onPress={() => handleCardPress(item)} style={[styles.card]}>
      <View style={styles.testCard}>
        <View style={styles.textLeft}>
          <Text style={styles.testRow}>{index + 1}</Text>
          <Text style={styles.columnPlayer}>{item.home_team}</Text>
          <Text style={styles.columnTotal}>{item.away_team}</Text>
          <Text style={styles.columnLosses}>{item.date}</Text>
        </View>
      </View>
    </TouchableOpacity>
    </ScrollView>
