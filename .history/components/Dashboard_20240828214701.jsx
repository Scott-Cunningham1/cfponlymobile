...
import { ScrollViewView, Text, FlatList, StyleSheet, ImageBackground, Image, Dimensions, TouchableOpacity } from 'react-native';
...
const TopCard = () => (
  ...
  const MiddleCard = () => (
    <View style={[styles.topCard, {backgroundColor: 'rgba(255, 255, 255, 0.2)'}]}>
  ...
  return (
    ...
    <FlatList
      ListHeaderComponent={<><MiddleCard /></>} // Add the top card component
