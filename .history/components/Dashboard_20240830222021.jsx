...
function ScoreDash() {
  ...
  // Function to repeatedly fetch data until all states are ready
  const ensureDataReady = useCallback(async () => {
    while (!isDataReady()) {
      setExecuting(true); // Indicate loading
      await getDashInfo(); // Fetch data
