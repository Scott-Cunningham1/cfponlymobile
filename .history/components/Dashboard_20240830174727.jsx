...
import { SectionList, View, Text, FlatList, StyleSheet, ImageBackground, Image, Dimensions, TouchableOpacity, ActivityIndicator } from 'react-native';
  ...
  return (
    <SectionList
      ...
      renderSectionHeader={({ section }) => (
        <View style={styles.titlesCard}>
          <Text style={styles.middleCardTextRank}>{section.title}</Text>
        </View>
      )}
