...
const styles = StyleSheet.create({
    header: {
        ...
        justifyContent: 'flex-end', // Centers image vertically
  ...
  image: {
    ...
    position: 'absolute', // Positions image absolutely within the header
    bottom: 0, // Aligns image to the bottom of the header
    left: 0,
  },
});
