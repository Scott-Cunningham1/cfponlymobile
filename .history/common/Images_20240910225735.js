...
const getImageSource = (teamName) => {
  ...
  const images = [
    ...
    {"keyword": "Texas A&M", "source": require('../assets/schools/texas_a&m.png')},
    {"keyword": "Texas", "source": require('../assets/schools/texas.png')},
    {"keyword": "USC", "source": require('../assets/schools/usc.png')},
    {"keyword": "Utah", "source": require('../assets/schools/utah.png')},
    {"keyword": "Virginia Tech", "source": require('../assets/schools/virginia_tech.png')},
    {"keyword": "West Virginia", "source": require('../assets/schools/miami.png')},
    {"keyword": "Michigan", "source": require('../assets/schools/michigan.png')},
    {"keyword": "Missouri", "source": require('../assets/schools/missouri.png')},
