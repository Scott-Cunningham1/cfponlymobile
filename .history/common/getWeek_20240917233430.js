const getWeek = async (date) => {
    ...
    const week5 = new Date('2024-10-01T03:24:02.441Z');
    const week6 = new Date('2024-10-08T03:24:02.441Z');
    const week7 = new Date('2024-10-15T03:24:02.441Z');
    const week8 = new Date('2024-10-22T03:24:02.441Z');
    const week9 = new Date('2024-10-24T03:24:02.441Z');
