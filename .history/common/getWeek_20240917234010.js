const getWeek = async (date) => {
    ...
    if(date > week9 && date < week10){
        return 10
    };
    if(date > week10 && date < week11){
        return 11
    };
    if(date > week11 && date < week12){
        return 12
    };
    if(date > week12 && date < week13){
        return 13
    };
    if(date > week13 && date < week14){
        return 14
    };
    if(date > week14 && date < week12){
        return 12
    };
